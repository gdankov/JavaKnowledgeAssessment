...
public class UserSession {
	...
	private int j = 0; // Test

	// get topics from database eventually

	private String[] topics = { "Core", "OOP", "DS" , "Database"};
	...
	public UserSession(int questionsPerTopic) {
		...
		REQUIRED_FOR_NEXT_LEVEL = (int) Math.round(questionsPerTopic * (75.0 / 100));
